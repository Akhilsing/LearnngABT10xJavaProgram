...
//Q: Java Program to check given number is Even and Odd

/*this defines a class name as Practice_012_5Divisible_P2, which is
   the entry point of the program.
 */
public class Practice_012_Even_Odd_P4 {
    ...
    public static void main(String[] args) {
        ...
        if(number%2==0){
            System.out.println("Given " + number + " is divisible by 2 is Even");
        }
        else{
            System.out.println("Given " + number + " is not divisible by 2 is Odd");
        }
